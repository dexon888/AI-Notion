  ...
  return (
    <div className="flex flex-wrap gap-2">
        ...
        className={editor.isActive('italic') ? "is-active" : ""}>
            <Italic className="w-6 h-6"></Italic>
        </button>

        <button onClick={() => editor.chain().focus().toggleStrike().run()}
        disabled={!editor.can().chain().focus().toggleStrike().run()}
        className={editor.isActive('strike') ? "is-active" : ""}>
            <Strikethrough className="w-6 h-6"></Strikethrough>
        </button>
        ...
        className={editor.isActive('heading', {level : 1}) ? "is-active" : ""}>
            <Heading1 className="w-6 h-6"></Heading1>
        </button>

        <button onClick={() => editor.chain().focus().toggleHeading({ level: 2}).run()}
        className={editor.isActive('heading', {level : 2}) ? "is-active" : ""}>
            <Heading2 className="w-6 h-6"></Heading2>
        </button>

        <button onClick={() => editor.chain().focus().toggleHeading({ level: 3}).run()}
        className={editor.isActive('heading', {level : 3}) ? "is-active" : ""}>
            <Heading3 className="w-6 h-6"></Heading3>
        </button>

        <button onClick={() => editor.chain().focus().toggleHeading({ level: 4}).run()}
        className={editor.isActive('heading', {level : 4}) ? "is-active" : ""}>
            <Heading4 className="w-6 h-6"></Heading4>
        </button>

        <button onClick={() => editor.chain().focus().toggleHeading({ level: 5}).run()}
        className={editor.isActive('heading', {level : 5}) ? "is-active" : ""}>
            <Heading5 className="w-6 h-6"></Heading5>
        </button>

        <button onClick={() => editor.chain().focus().toggleHeading({ level: 6}).run()}
        className={editor.isActive('heading', {level : 6}) ? "is-active" : ""}>
            <Heading6 className="w-6 h-6"></Heading6>
        </button>

        <button onClick={() => editor.chain().focus().toggleBulletList().run()}
        className={editor.isActive('bulletList') ? "is-active" : ""}>
            <List className="w-6 h-6"></List>
        </button>

        <button onClick={() => editor.chain().focus().toggleOrderedList().run()}
        className={editor.isActive("orderedList") ? "is-active" : ""}>
            <ListOrdered className="w-6 h-6"></ListOrdered>
        </button>

        <button onClick={() => editor.chain().focus().toggleCodeBlock().run()}
        className={editor.isActive('codeblock') ? "is-active" : ""}>
            <CodepenIcon className="w-6 h-6"></CodepenIcon>
        </button>
